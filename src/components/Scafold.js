...
function Scafold() {
  ...
  return (
    <div className="main-container-menu">
      <div onClick={handleClick} className={click ? "buttons-container active" : "buttons-container" }>
        <Link to="/about">
          <button
            value="about"
        ...
        <Link to="/gallery">
          <button
            ...
            onClick={handleToggle}
            className={
              isActive["gallery"] ? "activeButton" : "Button"
            }
          >
            GALERÍA
          </button>
        ...
        <Link to="/contact">
          <button
            ...
            onClick={handleToggle}
            className={
              isActive["contact"] ? "activeButton" : "Button"
            }
          >
            CONTACTO
          </button>
